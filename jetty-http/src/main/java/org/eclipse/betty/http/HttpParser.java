...
public class HttpParser
{
    ...
    @Deprecated
    public final static String __STRICT="HttpParser.STRICT";
            ...
            if (_header!=null)
            {
                ...
                switch (_header)
                {
                    case CONTENT_LENGTH:
                        ...
                        else if (_endOfContent != HttpTokens.EndOfContent.CHUNKED_CONTENT)
                        {
                    ...
                    switch(b)
                    {
                        ...
                        case HttpTokens.LINE_FEED:
                        {
                            ...
                            if (_responseHandler !=null  && // response
                                ...
                                _endOfContent= HttpTokens.EndOfContent.NO_CONTENT; // ignore any other headers set
