...
public class NullSessionCache extends AbstractSessionCache
{
    ...
    /** 
     * @see AbstractSessionCache#doGet(java.lang.String)
     */
    @Override
    ...
    /** 
     * @see AbstractSessionCache#doPutIfAbsent(java.lang.String, Session)
     */
    @Override
    ...
    /** 
     * @see AbstractSessionCache#doDelete(java.lang.String)
     */
    @Override
    ...
    /** 
     * @see AbstractSessionCache#setEvictionPolicy(int)
     */
    @Override
