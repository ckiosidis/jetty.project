...
public abstract class AbstractSessionDataStore extends ContainerLifeCycle implements SessionDataStore
{
    ...
    /** 
     * @see SessionDataStore#initialize(SessionContext)
     */
    ...
    /** 
     * @see SessionDataStore#store(java.lang.String, SessionData)
     */
    @Override
    ...
    /** 
     * @see SessionDataStore#getExpired(java.util.Set)
     */
    @Override
    ...
    /** 
     * @see SessionDataStore#newSessionData(java.lang.String, long, long, long, long)
     */
    @Override
