 ...
 * {@link SessionHandler} which checks for session cookies and enables the ability to create new sessions.</li>
 *
 ...
 * {@link ContextHandler#getMaxFormContentSize()} or if there is no context then the "Request.maxFormContentSize" {@link Server}
...
public class Request implements HttpServletRequest
{
    ...
    public void extractFormParameters(MultiMap<String> params)
    {
        try
        {
            ...
            {
                Object obj = _channel.getServer().getAttribute("Request.maxFormContentSize");
                if (obj == null)
            ...
            if (maxFormKeys < 0)
            {
                Object obj = _channel.getServer().getAttribute("Request.maxFormKeys");
                if (obj == null)
                    maxFormKeys = 1000;
                else if (obj instanceof Number)
                {
     ...
     * <dl>
     * <dt>Server</dt><dd>The Jetty Server instance</dd>
     * <dt>HttpChannel</dt><dd>The HttpChannel for this request</dd>
     * <dt>HttpConnection</dt><dd>The HttpConnection or null if another transport is used</dd>
     * </dl>
    ...
    public void setAttribute(String name, Object value)
    {
        ...
        if ("Request.queryEncoding".equals(name))
