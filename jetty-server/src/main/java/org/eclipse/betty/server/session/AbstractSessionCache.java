...
package org.eclipse.betty.server.session;
...
import org.eclipse.betty.util.thread.Locker.Lock;
...
public abstract class AbstractSessionCache extends ContainerLifeCycle implements SessionCache
{
     ...
     */
    protected int _evictionPolicy = NEVER_EVICT;
    ...
    /** 
     * @see SessionCache#initialize(SessionContext)
     */
    ...
    /** 
     * @see SessionCache#setSessionDataStore(SessionDataStore)
     */
    ...
    /** 
     * @see SessionCache#getEvictionPolicy()
     */
     ...
     * 
     * @see SessionCache#setEvictionPolicy(int)
     */
     ...
     * session manager.
     * 
     * @see SessionCache#get(java.lang.String)
     */
    @Override
     ...
     * 
     * @see SessionCache#put(java.lang.String, Session)
     */
    @Override
     ...
     * 
     * @see SessionCache#exists(java.lang.String)
     */
    @Override
     ...
     * 
     * @see SessionCache#contains(java.lang.String)
     */
    @Override
     ...
     * 
     * 
     * @see SessionCache#delete(java.lang.String)
     */
    @Override
    ...
    /** 
     * @see SessionCache#checkExpiration(Set)
     */
    @Override
    ...
    /** 
     * @see SessionCache#renewSessionId(java.lang.String, java.lang.String)
     */
    ...
    /** 
     * @see SessionCache#setSaveOnInactiveEviction(boolean)
     */
    @Override
    ...
    /** 
     * @see SessionCache#newSession(javax.servlet.http.HttpServletRequest, java.lang.String, long, long)
     */
    @Override
