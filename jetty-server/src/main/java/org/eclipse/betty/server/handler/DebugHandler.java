...
import org.eclipse.betty.server.DebugListener;
...
public class DebugHandler extends HandlerWrapper implements Connection.Listener
{
    ...
    /* ------------------------------------------------------------ */
    /*
     * @see Handler#handle(java.lang.String, javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, int)
     */
    @Override
