...
package org.eclipse.betty.util.log;
...
public class Log
{
    ...
    static
    {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                 ...
                 */
                __logClass = __props.getProperty("org.eclipse.jetty.util.log.class","Slf4jLog");
    ...
    public static void setLogToParent(String name)
    {
        ...
        if (loader!=null && loader.getParent()!=null)
        {
            try
            {
                Class<?> uberlog = loader.getParent().loadClass("org.eclipse.betty.util.log.Log");
