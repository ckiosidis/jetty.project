...
package org.eclipse.betty.util.thread.strategy;

import java.util.concurrent.Executor;

import org.eclipse.betty.util.log.Log;
import org.eclipse.betty.util.log.Logger;
import org.eclipse.betty.util.thread.Invocable;
...
public class ExecuteProduceConsume implements ExecutionStrategy, Runnable
{
    ...
    public void produce()
    {
        ...
        try (Locker.Lock locked = _locker.lock())
        {
    ...
    private void produceConsume()
    {
        ...
        while (true)
        {
            ...
            try (Locker.Lock locked = _locker.lock())
            {
                ...
                {
                    // dispatch one
                    dispatch = _pending = Invocable.getInvocationType(task)!= Invocable.InvocationType.NON_BLOCKING;
                }
